...
export const metadata = {
  title: 'Soluciones de Medicare y Seguros en las que Puedes Confiar',
  description: 'Sirviendo a Louisiana, Florida y Mississippi por más de 25 años. Orientación experta para Medicare Advantage, Suplementos de Medicare, Seguros Dentales y de Visión.',
  alternates: {
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroText}>
              ...
              <div className={styles.heroCta}>
                <Link href="/es/contact" className="btn btn-primary btn-large">
                  {t.home.hero.cta1}
                </Link>
